...
void TMM(long N, long ts1_l1, long ts2_l1, long ts3_l1, float** A, float** B, float** R){
	...
	#define S1(i,j,k) R(k,j) = (R(k,j))+((A(k,i))*(B(i,j)))
	#define S2(i,j,k) R(k,j) = (A(k,i))*(B(i,j))
	#define S0(i,j,i2) R(i2,j) = R(i2,j)
	{
		//Domain
		//{i,j,k|k>=1 && N>=j && j>=i && i>=k+1 && i>=2 && N>=i && j>=k && j>=1 && N>=1}
		//{i,j,k|k==i && i>=1 && N>=j && j>=i && j>=1 && N>=i && N>=1}
		//{i,j,i2|i==N && j>=1 && N>=j && i2>=1 && j>=i2 && N>=1}
				 	 	 ...
				 	 	 {
				 	 	 	{
				 	 	 		for(c1=max(ti1_l1,1);c1 <= min(ti1_l1+ts1_l1-1,1);c1+=1)
				 	 	 		 {
				 	 	 		 	for(c2=max(ti2_l1,1);c2 <= min(ti2_l1+ts2_l1-1,N);c2+=1)
				 	 	 		 	 {
				 	 	 		 	 	for(c3=max(ti3_l1,1);c3 <= min(ti3_l1+ts3_l1-1,1);c3+=1)
				 	 	 		 	 	 {
				 	 	 		 	 	 	S2((1),(c2),(1));
		...
		for(ti1_l1=(ceild((-ts1_l1+3),(ts1_l1))) * (ts1_l1);ti1_l1 <= N-1;ti1_l1+=ts1_l1)
		 {
		 	for(ti2_l1=(ceild((ti1_l1-ts2_l1+1),(ts2_l1))) * (ts2_l1);ti2_l1 <= N;ti2_l1+=ts2_l1)
		 	 {
		 	 	for(ti3_l1=(ceild((-ts3_l1+2),(ts3_l1))) * (ts3_l1);ti3_l1 <= ti1_l1+ts1_l1-1;ti3_l1+=ts3_l1)
		 	 	 {
		 	 	 	{
		 	 	 		for(c1=max(ti1_l1,2);c1 <= min(ti1_l1+ts1_l1-1,N-1);c1+=1)
		 	 	 		 {
		 	 	 		 	for(c2=max(ti2_l1,c1);c2 <= min(ti2_l1+ts2_l1-1,N);c2+=1)
		 	 	 		 	 {
		 	 	 		 	 	for(c3=max(ti3_l1,1);c3 <= min(ti3_l1+ts3_l1-1,c1-1);c3+=1)
		 	 	 		 	 	 {
		 	 	 		 	 	 	S1((c1),(c2),(c3));
		 	 	 		 	 	 }
				...
				for(ti1_l1=(ceild((N-ts1_l1+1),(ts1_l1))) * (ts1_l1);ti1_l1 <= N;ti1_l1+=ts1_l1)
				 {
				 	for(ti2_l1=(ceild((-ts2_l1+2),(ts2_l1))) * (ts2_l1);ti2_l1 <= N;ti2_l1+=ts2_l1)
				 	 {
				 	 	for(ti3_l1=(ceild((-ts3_l1+2),(ts3_l1))) * (ts3_l1);ti3_l1 <= max(ti2_l1+ts2_l1-1,N);ti3_l1+=ts3_l1)
				 	 	 {
				 	 	 	{
				 	 	 		for(c1=max(ti1_l1,N);c1 <= min(ti1_l1+ts1_l1-1,N);c1+=1)
				 	 	 		 {
				 	 	 		 	for(c2=max(ti2_l1,1);c2 <= min(ti2_l1+ts2_l1-1,N-1);c2+=1)
				 	 	 		 	 {
				 	 	 		 	 	for(c3=max(ti3_l1,1);c3 <= min(ti3_l1+ts3_l1-1,c2);c3+=1)
				 	 	 		 	 	 {
				 	 	 		 	 	 	S0((N),(c2),(c3));
				 	 	 		 	 	 }
				 	 	 		 	 }
				 	 	 		 	for(c2=max(ti2_l1,N);c2 <= min(ti2_l1+ts2_l1-1,N);c2+=1)
				 	 	 		 	 {
				 	 	 		 	 	for(c3=max(ti3_l1,1);c3 <= min(ti3_l1+ts3_l1-1,N-1);c3+=1)
				 	 	 		 	 	 {
				 	 	 		 	 	 	S1((N),(N),(c3));
				 	 	 		 	 	 	S0((N),(N),(c3));
				 	 	 		 	 	 }
